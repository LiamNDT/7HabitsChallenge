//
//  DefinitionDetailEditDataSource.swift
//  7HabitsChallenge
//
...
class DefinitionDetailEditDataSource: UITableViewDiffableDataSource<DefinitionDetailEditDataSource.DefinitionSection, LifeThings.Aspect> {
    ...
    enum DefinitionSection: Int, CaseIterable, Hashable {
        ...
        var displayText: String {
            ...
            case .content:
                return ""
            case .aspects:
                return "Thuộc về khía cạnh cuộc sống"
            }
        }
        ...
        func cellIdentifier() -> String {
            ...
            case .aspects:
                return aspectEditCellReuseIdentifier
            }
        }
    }
